...
AbstractMesh.prototype.doRenderOrdered = function (dc) {
    ...
    if (!currentData.pointsVboCacheKey) {
        ...
        this.saveKeyEntry(currentData.pointsVboCacheKey);
    }
    ...
    if (this.activeAttributes.drawInterior) {
        ...
        if (!currentData.meshIndicesVboCacheKey) {
            ...
            this.saveKeyEntry(currentData.meshIndicesVboCacheKey);
        }
        ...
        if (hasTexture && (!dc.pickingMode || !this.pickTransparentImagePixels)) {
            ...
            if (textureBound) {
                if (!currentData.texCoordsVboCacheKey) {
                    ...
                    this.saveKeyEntry(currentData.texCoordsVboCacheKey);
                }
        ...
        if (applyLighting) {
            ...
            if (!currentData.normalsVboCacheKey) {
                ...
                this.saveKeyEntry(currentData.normalsVboCacheKey);
            }
    ...
    if (this.activeAttributes.drawOutline && this.meshOutlineIndices) {
        ...
        if (!currentData.outlineIndicesVboCacheKey) {
            ...
            this.saveKeyEntry(currentData.outlineIndicesVboCacheKey);
        }
...
AbstractMesh.prototype.saveKeyEntry = function (keyEntry) {
...
AbstractMesh.prototype.destroy = function (dc) {
    for (var i = 0; i < this._cacheKeys.length; i++) {
        dc.gpuResourceCache.removeResource(this._cacheKeys[i]);
    }
